"""Catalogo de casos. Cada uno declara su `esperado`, y por eso es suite de regresion.
...
CASOS = [
    Caso(1, "Apagar el host esta fundado, y aun asi es la peor opcion",
    ...
    Caso(2, "La misma accion, dos horas antes, no estaba fundada",
    ...
    Caso(3, "La misma accion, al cierre, si lo esta",
    ...
    Caso(4, "Bloquear la IP interna del servidor de facturacion no esta fundado",
    ...
    Caso(5, "Bloquear la IP del ataque si lo esta",
    ...
    Caso(6, "Actuar sobre un host que no aparece en la evidencia",
    ...
    Caso(7, "Rotar claves SSH en la estacion Windows",
